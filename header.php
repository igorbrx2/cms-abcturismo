...
<html lang="pt-BR">
  ...
  <body>
    <!-- HEADER -->
    <header id="header">
      <a id="logo" href="./"><img src="<?php echo get_stylesheet_directory_uri(); ?>/imgs/logo.png" alt="" /></a>
      <nav id="navegacao">
        <ul id="menu">
          <li>
            <a
      ...
      <ul class="rd-sociais">
        <li>
          <a
            ...
            target="_blank"
            ><img src="<?php echo get_stylesheet_directory_uri(); ?>/imgs/wpp.png" alt=""
          /></a>
        </li>
        <li>
          <a
            ...
            target="_blank"
            ><img src="<?php echo get_stylesheet_directory_uri(); ?>/imgs/ig.png" alt=""
          /></a>
        </li>
        <li>
          <a
            ...
            target="_blank"
            ><img src="<?php echo get_stylesheet_directory_uri(); ?>/imgs/thds.png" alt=""
          /></a>
        </li>
      </ul>
